...
import { Disposable, Event, RendererComponent } from "openbim-components";
 ...
 */
export class MapboxAdvancedRenderer extends RendererComponent implements Disposable {
  /** {@link Component.name} */
  name = "MapboxRenderer";
  ...
  updateCoordinates(value: any){
    this._modelTransform = this.newModelTransform(value, new THREE.Vector3(Math.PI / 2, 0, 0));
  }
